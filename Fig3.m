...
xlim([0 175])
ylim([-1 1.1])
xticks([20:30:170]); xticklabels({'0','10'}); 
yticks([]); yticklabels({''});
xlabel('Time (AU)')
alpha(ax1_1,0)
...
ylabel('{\it \xi(t)}_2','FontName','Arial', 'FontSize', 12); 
...
exportgraphics(gcf,'/Users/martinesparzaiaizzo/Library/CloudStorage/GoogleDrive-martineladio.esparza01@alumni.upf.edu/My Drive/PaperBelen/Figures/Temp Figures/fig3.pdf','Resolution',300,'BackgroundColor','none')